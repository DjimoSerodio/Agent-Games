              ...
              >
                <div className="flex justify-between gap-2.5 items-start">
                  <div className="flex items-center gap-2">
                    <div className={`inline-flex items-center px-2 py-1.5 rounded-full font-mono text-[10px] tracking-[0.12em] uppercase leading-none border whitespace-nowrap ${
                      isPrivate 
                    ...
                    <div className="font-serif text-[18px] text-[var(--color-text)] min-w-0 whitespace-nowrap overflow-hidden text-ellipsis">
                      ...
                      {isPrivate && msg.recipient && ` → ${formatAgentName(msg.recipient, context)}`}
                    </div>
                  </div>
                ...
                <div className={`mt-2.5 text-[13px] leading-[1.52] text-[var(--color-text-muted)] break-words ${isDiary ? 'italic' : ''}`}>
                  {msg.content}
                </div>
              </div>
            );
